...
const Procedure = () => {
    return (
        <div className="m-20">
            ...
            <div className="h-120 flex items-center m-10 p-20 gap-10 justify-between relative">
                <img
                    src={bannerImage}
                    alt="Banner"
                    className="absolute top-0 right-0 h-140 w-220  z-0"
                />
                <div className="relative flex flex-col mt-20 gap-10">

                    <div className="relative flex flex-row gap-5 border-1 rounded-xl w-150 h-30 bg-white p-5">
                        ...
                        <div className="">
                            ...
                            <p>Choose from our wide range of premium cars, select the <br />pickup and return dates and locations that suit you best.</p>
                        </div>
                    </div>
                    <div className="relative flex flex-row gap-5 border-1 rounded-xl w-150 h-30 bg-white p-5">
                        <div className="bg-gray-200 rounded w-15 h-20 flex items-center justify-center">
